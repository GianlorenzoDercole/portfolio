...
<div className={styles.portfolio_pic}>
    ...
    <h3 className='whiteText'>Django Cocktails</h3>
    <p className='whiteText'>Python, Django, CSS</p>
    <p className='whiteText'>Blog built with python, deployed with AWS</p>
    {/* <a href='https://forza-favorites.herokuapp.com/' className='whiteText'><button className={styles.smallbutton}>Try it</button></a> */}
    <a href='http://django-cocktails-env.eba-uppt6yjw.us-east-2.elasticbeanstalk.com/' className='whiteText'><button className={styles.smallbutton}>Try it</button></a>
    <a href='https://github.com/GianlorenzoDercole/django_blog_cocktail' className='whiteText'><button className={styles.smallbuttonr}>GitHub</button></a>
</div>
...
<Image
    ...
    <p className='whiteText'>Python, Django, Tailwind</p>
...
<div className={styles.portfolio_pic}>
    ...
    <p className='whiteText'>React, Axios, CSS</p>
...
<div className='bg'>
    ...
    <div className=' flex-space mts'>
                ...
                <Image className='margin-left'
                    ...
                    width={60}
                />
                <p className={styles.bold}>Python</p>
                </div>
  </div>
